...
with open(fileName, 'r') as inputFile:
	for line in inputFile:
		if (re.search(': connect from unknown',line)):
	...
	print("Total Unknown connection: " + str(len(Counter(unknown).most_common())) + " - " + Counter(unknown).most_common(1)[0][0] + " accounts for " + str(Counter(unknown).most_common(1)[0][1]) + " connections")
